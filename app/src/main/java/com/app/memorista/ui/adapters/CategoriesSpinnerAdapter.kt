...
import com.app.memorista.databinding.ItemSpinnerTasksListBinding
import com.app.memorista.databinding.ItemSpinnerTasksListDropdownBinding
 ...
 */
class CategoriesSpinnerAdapter(private val context: Context, val items: List<TaskListUI>) :
    BaseAdapter() {
